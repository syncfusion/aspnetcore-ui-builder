 ...
 *
 * Maps user queries (element type + content hints) to Syncfusion ASP.NET Core components
...
/**
 * Map user queries to Syncfusion ASP.NET Core components using BM25 search.
 */
